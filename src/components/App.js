    ...
    <>
      <div className="page">
        ...
        >
          ...
          <button type="submit" className="popup__btn-save" title="Сохранить">
            Сохранить
          </button>
        </PopupWithForm>
        ...
        >
          ...
          <button type="submit" className="popup__btn-save" title="Создать">
            Создать
          </button>
        </PopupWithForm>
        ...
        >
          <button
            type="button"
            className="popup__btn-save popup__btn-save-deleteImg"
            title="Да"
          >
            Да
          </button>
